        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold text-gray-800 mb-6">{{ __('users.edit_user_title', ['name' => $user->name]) }}</h1>
                    ...
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <!-- Name -->
                        <div>
                            <label for="name" class="block font-medium text-sm text-gray-700">{{ __('users.display_name') }}</label>
                        ...
                        <!-- Username -->
                        <div class="mt-4">
                            <label for="username" class="block font-medium text-sm text-gray-700">{{ __('users.username') }}</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <!-- First Name -->
                            <div>
                                <label for="first_name" class="block font-medium text-sm text-gray-700">{{ __('users.first_name') }}</label>
                            ...
                            <!-- Last Name -->
                            <div>
                                <label for="last_name" class="block font-medium text-sm text-gray-700">{{ __('users.last_name') }}</label>
                        ...
                        <!-- Email Address -->
                        <div class="mt-4">
                            <label for="email" class="block font-medium text-sm text-gray-700">{{ __('users.email') }}</label>
                        ...
                        <!-- Password -->
                        <div class="mt-4">
                            <label for="password" class="block font-medium text-sm text-gray-700">{{ __('users.new_password') }} ({{ __('users.password_hint') }})</label>
                        ...
                        <!-- Confirm Password -->
                        <div class="mt-4">
                            <label for="password_confirmation" class="block font-medium text-sm text-gray-700">{{ __('users.confirm_new_password') }}</label>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            ...
                            <button type="submit" class="ml-4 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                                {{ __('common.update') }} {{ __('users.user') }}
                            </button>
                        </div>
                    </form>
                </div>
