        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-bold mb-4">{{ __('users.add_new_address') }}</h1>
                    ...
                    <form action="{{ route('user.addresses.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="recipient_name" id="recipient_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('recipient_name') }}" required>
                        </div>
                        <div class="mb-4">
                            <label for="recipient_phone" class="block text-sm font-medium text-gray-700">{{ __('users.recipient_phone') }}</label>
                            <input type="text" name="recipient_phone" id="recipient_phone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('recipient_phone') }}" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="address" id="address" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('address') }}" required>
                        </div>
                        <div class="mb-4">
                            <label for="is_default" class="inline-flex items-center">
                                <input type="checkbox" name="is_default" id="is_default" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div class="flex items-center justify-end">
                            ...
                            <button type="submit" class="bg-gray-900 text-white font-bold py-2 px-4 rounded">{{ __('users.create') }}</button>
                        </div>
                    </form>
                </div>
            </div>
